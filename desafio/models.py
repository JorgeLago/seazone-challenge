...
class Imovel(models.Model):
    ...
    imovel_id = models.AutoField(primary_key=True)
...
class Anuncio(models.Model):
    ...
    imovel_id = models.ForeignKey(Imovel, on_delete=models.CASCADE, related_name="Anuncios")
...
class Reserva(models.Model):
    ...
    anuncio_id = models.ForeignKey(Anuncio, on_delete=models.CASCADE, related_name="Reservas")
